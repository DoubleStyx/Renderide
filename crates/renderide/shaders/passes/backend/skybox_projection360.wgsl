...
struct Projection360Material {
    ...
    _TextureLerp: f32,
    _CubeLOD: f32,
    _MainCube_LodBias: f32,
    _SecondCube_LodBias: f32,
...
fn projection360_params() -> p360m::Projection360Params {
    return p360m::Projection360Params(
        ...
        mat._TextureLerp,
        mat._CubeLOD,
        mat._MainCube_LodBias,
        mat._SecondCube_LodBias,
...
fn fs_main(in: VertexOutput) -> @location(0) vec4<f32> {
    ...
    return rg::retain_globals_additive(p360m::finish_skybox_sample(sample, params));
}
