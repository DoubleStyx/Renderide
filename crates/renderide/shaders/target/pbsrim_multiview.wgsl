...
fn cluster_view_space_z_coeffsX_naga_oil_mod_XOJSW4ZDFOJUWIZJ2HJYGE4Z2HJRWY5LTORSXEX(view_index_1: u32, left_1: vec4<f32>, right_1: vec4<f32>, stereo_cluster_layers_1: u32) -> vec4<f32> {
    let _e4: vec4<f32> = select_eye_view_space_z_coeffsX_naga_oil_mod_XOJSW4ZDFOJUWIZJ2HJYGE4Z2HJRWY5LTORSXEX(view_index_1, left_1, right_1, stereo_cluster_layers_1);
    return _e4;
}
...
fn cluster_id_from_fragX_naga_oil_mod_XOJSW4ZDFOJUWIZJ2HJYGE4Z2HJRWY5LTORSXEX(clip_xy: vec2<f32>, world_pos_4: vec3<f32>, view_space_z_coeffs: vec4<f32>, viewport_w_1: u32, viewport_h_1: u32, cluster_count_x: u32, cluster_count_y: u32, cluster_count_z_1: u32, near_clip_1: f32, far_clip_1: f32, view_index_2: u32, stereo_cluster_layers_2: u32) -> u32 {
    ...
    let offset: u32 = select(0u, (view_index_2 * per_eye), (stereo_cluster_layers_2 > 1u));
...
fn fs_main(@builtin(position) frag_pos: vec4<f32>, @builtin(view_index) view_idx_1: u32, @location(0) world_pos: vec3<f32>, @location(1) world_n: vec3<f32>, @location(2) uv0_1: vec2<f32>) -> @location(0) vec4<f32> {
    ...
    let _e81: vec4<f32> = cluster_view_space_z_coeffsX_naga_oil_mod_XOJSW4ZDFOJUWIZJ2HJYGE4Z2HJRWY5LTORSXEX(view_idx_1, _e73, _e76, _e79);
    ...
    let _e108: u32 = cluster_id_from_fragX_naga_oil_mod_XOJSW4ZDFOJUWIZJ2HJYGE4Z2HJRWY5LTORSXEX(frag_pos.xy, world_pos, _e81, _e86, _e89, _e92, _e95, _e98, _e101, _e104, view_idx_1, _e107);
