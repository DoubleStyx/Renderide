...
//!
//! Unity's `#pragma surface surf StandardSpecular fullforwardshadows addshadow` uses a
//! material-driven `Cull [_Cull]` state whose default disables culling. This renderer keeps a single
//! clustered forward color pass with the same cull fallback.
//!
