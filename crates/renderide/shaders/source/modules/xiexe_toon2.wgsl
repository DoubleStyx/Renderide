...
/// `4π/range²` range-coupling term so that `range` participates in perceived brightness. This
/// diverges from pure Filament/Bevy inverse-square to match Resonite's BiRP-style authoring
/// convention where `intensity` behaves as a luminous-power-like quantity spread over the light's
/// working volume.
