//! FurFX 1.x self-shadow material bindings and shading.

#define_import_path renderide::fur::classic_selfshadow
...
struct ClassicSelfShadowMaterial {
    _Color: vec4<f32>,
    _SpecColor: vec4<f32>,
    _RimColor: vec4<f32>,
...
fn shell_emission(input: furc::VertexOutput, alpha: f32, direct_visibility: f32) -> vec3<f32> {
    ...
    return rim + reflection * max(mat._Reflection, 0.0) * alpha * direct_visibility;
}
