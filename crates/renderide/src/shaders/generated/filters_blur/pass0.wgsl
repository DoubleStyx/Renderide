...
struct GlobalParams_std140_0
{
    ...
    @align(16) _RefractionStrength_0 : f32,
};
...
struct v2f_0
{
    ...
    @location(6) tangent_0 : vec3<f32>,
    @location(3) bitangent_0 : vec3<f32>,
...
{
    const _S2 : vec4<f16> = vec4<f16>(0.0h, 0.0h, 0.0h, 0.0h);
    var _S3 : f16 = f16(6.28318548202514648f / iterations_0);
    ...
    for(;;)
    {
        ...
        var angle_0 : f32 = f32(_S3 * f16(n_0));
...
@fragment
fn frag( _S4 : pixelInput_0, @builtin(position) pos_1 : vec4<f32>) -> pixelOutput_0
{
    var _S5 : v2f_0;
    _S5.uv_2 = _S4.uv_1;
    _S5.grabPos_1 = _S4.grabPos_0;
    _S5.depth_2 = _S4.depth_1;
    _S5.pos_0 = pos_1;
    _S5.normal_1 = _S4.normal_0;
    _S5.tangent_1 = _S4.tangent_0;
    _S5.bitangent_1 = _S4.bitangent_0;
    _S5.position_2 = _S4.position_1;
    if(USC_RECTCLIP_0)
    {
        if((UnityGet2DClipping_0(_S5.position_2, globalParams_0._Rect_0) - 0.10000000149011612f) < 0.0f)
        {
            discard;
        }
    }
    var grabUv_0 : vec2<f32> = _S5.grabPos_1.xy / vec2<f32>(_S5.grabPos_1.w);
    var _S6 : bool;
    if(USC_REFRACT_0)
    {
        _S6 = true;
    ...
    {
        _S6 = USC_REFRACT_NORMALMAP_0;
    }
    var grabUv_1 : vec2<f32>;
    if(_S6)
    {
        var _S7 : mat4x4<f32> = mat4x4<f32>(UnityPerFrame_0.unity_MatrixV_0.data_0[i32(0)][i32(0)], UnityPerFrame_0.unity_MatrixV_0.data_0[i32(1)][i32(0)], UnityPerFrame_0.unity_MatrixV_0.data_0[i32(2)][i32(0)], UnityPerFrame_0.unity_MatrixV_0.data_0[i32(3)][i32(0)], UnityPerFrame_0.unity_MatrixV_0.data_0[i32(0)][i32(1)], UnityPerFrame_0.unity_MatrixV_0.data_0[i32(1)][i32(1)], UnityPerFrame_0.unity_MatrixV_0.data_0[i32(2)][i32(1)], UnityPerFrame_0.unity_MatrixV_0.data_0[i32(3)][i32(1)], UnityPerFrame_0.unity_MatrixV_0.data_0[i32(0)][i32(2)], UnityPerFrame_0.unity_MatrixV_0.data_0[i32(1)][i32(2)], UnityPerFrame_0.unity_MatrixV_0.data_0[i32(2)][i32(2)], UnityPerFrame_0.unity_MatrixV_0.data_0[i32(3)][i32(2)], UnityPerFrame_0.unity_MatrixV_0.data_0[i32(0)][i32(3)], UnityPerFrame_0.unity_MatrixV_0.data_0[i32(1)][i32(3)], UnityPerFrame_0.unity_MatrixV_0.data_0[i32(2)][i32(3)], UnityPerFrame_0.unity_MatrixV_0.data_0[i32(3)][i32(3)]);
        var _S8 : vec3<f32> = (((_S5.normal_1) * (mat3x3<f32>(_S7[i32(0)].xyz, _S7[i32(1)].xyz, _S7[i32(2)].xyz))));
        _S5.normal_1 = _S8;
        grabUv_1 = grabUv_0 - _S8.xy / vec2<f32>(_S5.grabPos_1.w) * vec2<f32>(globalParams_0._RefractionStrength_0);
    }
    else
    {
        grabUv_1 = grabUv_0;
    }
    var _S9 : pixelOutput_0 = pixelOutput_0( evrCalculateBlur_0(grabUv_1, _S5.uv_2, _S5.depth_2, globalParams_0._Iterations_0) );
    return _S9;
}
