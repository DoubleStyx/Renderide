...
@binding(33) @group(0) var sampler_GrabTexture_0 : sampler;
...
fn frag( _S4 : pixelInput_0, @builtin(position) pos_0 : vec4<f32>) -> pixelOutput_0
{
    ...
    var _S5 : pixelOutput_0 = pixelOutput_0( vec4<f16>((textureSample((_GrabTexture_0), (unity_usc_resonite_macro_sampler_0), (vec2<f32>(evrCalculateRefractionCoords_0(_S4.grabPos_1.xy / vec2<f32>(_S4.grabPos_1.w), _S4.uv_1, _S4.depth_1, _S4.tangent_1, _S4.bitangent_1, _S4.normal_1, _S4.grabPos_1)))))) );
    return _S5;
}
