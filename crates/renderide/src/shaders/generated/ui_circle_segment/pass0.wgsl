...
struct v2f_0
{
    @location(0) pos_6 : vec4<f32>,
    @location(6) uv_0 : vec2<f32>,
    @location(4) position_0 : vec2<f32>,
    @location(7) fill_color_0 : vec4<f32>,
    @location(8) border_color_0 : vec4<f32>,
    @location(1) angle_data_0 : vec2<f32>,
    @location(2) radius_data_0 : vec2<f32>,
    @location(3) extra_data_0 : vec2<f32>,
    @location(5) projPos_0 : vec4<f32>,
};
...
{
    var _S5 : f32 = _S4.angle_data_1.x;
    var angle_dif_0 : f32 = _S5 - angle_compensation_0(_S5, _S4.angle_data_1.y);
    var _S6 : f32 = cos(angle_dif_0);
    var _S7 : f32 = sin(angle_dif_0);
    var rot_0 : mat2x2<f32> = mat2x2<f32>(_S6, - _S7, _S7, _S6);
    var o_1 : v2f_0;
    var _S8 : vec4<f32> = UnityObjectToClipPos_1(_S4.vertex_0);
    o_1.pos_6 = _S8;
    o_1.uv_0 = (((_S4.uv_1) * (rot_0)));
    o_1.position_0 = _S4.vertex_0.xy;
    o_1.fill_color_0 = _S4.fill_color_1;
    o_1.border_color_0 = _S4.border_color_1;
    o_1.angle_data_0 = _S4.angle_data_1;
    o_1.radius_data_0 = _S4.radius_data_1;
    o_1.extra_data_0 = _S4.extra_data_1;
    o_1.projPos_0 = ComputeScreenPos_0(_S8);
...
fn compute_strength_0( angle_dist_0 : f32,  radius_dist_0 : f32,  corner_radius_0 : f32) -> f32
{
    ...
    {
        _S2 = radius_dist_0 < corner_radius_0;
    }
    else
    {
        _S2 = false;
...
fn frag( _S3 : pixelInput_0) -> pixelOutput_0
{
    if(USC_RECTCLIP_0)
    {
        if((UnityGet2DClipping_0(_S3.position_1, globalParams_0._Rect_0) - 0.10000000149011612f) < 0.0f)
        {
            discard;
        }
    }
    var radius_0 : f32 = length(_S3.uv_0);
    var _S4 : f32 = _S3.angle_data_0.y;
    var angle_0 : f32 = atan2(- _S3.uv_0.y, _S3.uv_0.x) + 3.14159274101257324f - angle_compensation_0(_S3.angle_data_0.x, _S4);
    var _S5 : f32 = _S3.radius_data_0.x;
    var _S6 : f32 = min(radius_0 - _S5, _S3.radius_data_0.y - radius_0);
    var remainingAngleLength_0 : f32 = (6.28318548202514648f - _S4) * _S5;
    var _S7 : f32 = min(_S3.extra_data_0.y, remainingAngleLength_0);
    var _S8 : f32 = _S3.extra_data_0.x;
    var _S9 : f32 = min(_S8, remainingAngleLength_0);
    var angle_dist_1 : f32 = min(angle_0, _S4 - angle_0) * radius_0 + max(0.0f, _S8 - _S9);
    var borderLerp_0 : f32 = compute_strength_0(angle_dist_1, _S6, _S7);
    var fillLerp_0 : f32 = compute_strength_0(angle_dist_1 - _S9, _S6 - _S8, _S7);
    if(borderLerp_0 <= 0.0f)
    {
        discard;
    }
    var border_c_0 : vec4<f16> = vec4<f16>(_S3.border_color_0 * globalParams_0._OutlineTint_0);
    border_c_0[i32(3)] = border_c_0[i32(3)] * f16(borderLerp_0);
    var c_0 : vec4<f16> = vec4<f16>(mix(vec4<f32>(border_c_0), _S3.fill_color_0 * globalParams_0._FillTint_0, vec4<f32>(fillLerp_0)));
    var c_1 : vec4<f16>;
    if(USC_OVERLAY_0)
    {
        if((_S3.projPos_0.z) > (LinearEyeDepth_0((textureSample((_CameraDepthTexture_0), (unity_usc_resonite_macro_sampler_0), (_S3.projPos_0.xy / vec2<f32>(_S3.projPos_0.w)))).x)))
        {
            c_1 = c_0 * vec4<f16>(globalParams_0._OverlayTint_0);
        }
        else
        {
            c_1 = c_0;
    ...
    var _S10 : pixelOutput_0 = pixelOutput_0( c_1 );
    return _S10;
}
