...
@binding(32) @group(0) var _BehindFarTex_0 : texture_2d<f32>;

@binding(33) @group(0) var sampler_BehindFarTex_0 : sampler;

@binding(34) @group(0) var _BehindNearTex_0 : texture_2d<f32>;

@binding(35) @group(0) var sampler_BehindNearTex_0 : sampler;
...
struct GlobalParams_std140_0
{
    ...
    @align(8) _Exp_0 : f32,
    @align(16) _BehindFarTex_ST_0 : vec4<f32>,
    @align(16) _BehindNearTex_ST_0 : vec4<f32>,
...
fn frag( _S3 : pixelInput_0, @builtin(position) vertex_1 : vec4<f32>) -> pixelOutput_0
{
    ...
    if(USC_TEXTURE_0)
    {
        if(USC_POLARUV_0)
        {
            ...
            var farColor_1 : vec4<f16> = globalParams_0._BehindFarColor_0 * vec4<f16>(SampleTex2Dpolar_0(_BehindFarTex_0, polarUv_2, globalParams_0._BehindFarTex_ST_0));
            nearColor_0 = globalParams_0._BehindNearColor_0 * vec4<f16>(SampleTex2Dpolar_0(_BehindNearTex_0, polarUv_2, globalParams_0._BehindNearTex_ST_0));
            farColor_0 = farColor_1;
        }
        else
        {
            var farColor_2 : vec4<f16> = globalParams_0._BehindFarColor_0 * vec4<f16>((textureSample((_BehindFarTex_0), (unity_usc_resonite_macro_sampler_0), (vec2<f32>(_S4.texcoord_1.xy) * globalParams_0._BehindFarTex_ST_0.xy + globalParams_0._BehindFarTex_ST_0.zw))));
            nearColor_0 = globalParams_0._BehindNearColor_0 * vec4<f16>((textureSample((_BehindNearTex_0), (unity_usc_resonite_macro_sampler_0), (vec2<f32>(_S4.texcoord_1.xy) * globalParams_0._BehindNearTex_ST_0.xy + globalParams_0._BehindNearTex_ST_0.zw))));
            farColor_0 = farColor_2;
        }
    }
    else
    {
        nearColor_0 = globalParams_0._BehindNearColor_0;
        farColor_0 = globalParams_0._BehindFarColor_0;
    }
