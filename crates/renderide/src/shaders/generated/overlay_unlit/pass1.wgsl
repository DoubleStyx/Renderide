...
@binding(32) @group(0) var _FrontTex_0 : texture_2d<f32>;

@binding(33) @group(0) var sampler_FrontTex_0 : sampler;
...
struct GlobalParams_std140_0
{
    ...
    @align(16) _FrontTex_ST_0 : vec4<f32>,
    @align(16) _FrontColor_0 : vec4<f16>,
...
fn frag( _S4 : pixelInput_0, @builtin(position) vertex_0 : vec4<f32>) -> pixelOutput_0
{
    ...
    if(USC_TEXTURE_0)
    {
        if(USC_POLARUV_0)
        {
            ...
            var uv_0 : vec2<f32> = PolarMapping_0(vec2<f32>(_S4.texcoord_0 * vec2<f16>(2.0h) - vec2<f16>(1.0h)), globalParams_0._FrontTex_ST_0, globalParams_0._PolarPow_0, &(uvddx_2), &(uvddy_2));
            col_0 = vec4<f16>((textureSampleGrad((_FrontTex_0), (unity_usc_resonite_macro_sampler_0), (uv_0), (uvddx_2), (uvddy_2))));
        }
        else
        {
            col_0 = vec4<f16>((textureSample((_FrontTex_0), (unity_usc_resonite_macro_sampler_0), (vec2<f32>(_S4.texcoord_0.xy) * globalParams_0._FrontTex_ST_0.xy + globalParams_0._FrontTex_ST_0.zw))));
        }
        col_0 = col_0 * globalParams_0._FrontColor_0;
    }
    else
    {
        col_0 = globalParams_0._FrontColor_0;
    }
    if(USC_ALPHATEST_0)
    {
