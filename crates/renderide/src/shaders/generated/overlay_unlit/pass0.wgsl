...
@binding(32) @group(0) var _BehindTex_0 : texture_2d<f32>;

@binding(33) @group(0) var sampler_BehindTex_0 : sampler;
...
struct GlobalParams_std140_0
{
    ...
    @align(16) _BehindTex_ST_0 : vec4<f32>,
    @align(16) _BehindColor_0 : vec4<f16>,
    @align(8) _PolarPow_0 : f32,
};
...
fn frag( _S4 : pixelInput_0, @builtin(position) vertex_0 : vec4<f32>) -> pixelOutput_0
{
    ...
    if(USC_TEXTURE_0)
    {
        if(USC_POLARUV_0)
        {
            ...
            var uv_0 : vec2<f32> = PolarMapping_0(vec2<f32>(_S4.texcoord_0 * vec2<f16>(2.0h) - vec2<f16>(1.0h)), globalParams_0._BehindTex_ST_0, globalParams_0._PolarPow_0, &(uvddx_2), &(uvddy_2));
            col_0 = vec4<f16>((textureSampleGrad((_BehindTex_0), (unity_usc_resonite_macro_sampler_0), (uv_0), (uvddx_2), (uvddy_2))));
        }
        else
        {
            col_0 = vec4<f16>((textureSample((_BehindTex_0), (unity_usc_resonite_macro_sampler_0), (vec2<f32>(_S4.texcoord_0.xy) * globalParams_0._BehindTex_ST_0.xy + globalParams_0._BehindTex_ST_0.zw))));
        }
        col_0 = col_0 * globalParams_0._BehindColor_0;
    }
    else
    {
        col_0 = globalParams_0._BehindColor_0;
    }
    if(USC_ALPHATEST_0)
    {
    ...
    {
        var _S5 : vec3<f16> = col_0.xyz * vec3<f16>(col_0.w);
        col_0.x = _S5.x;
        col_0.y = _S5.y;
        col_0.z = _S5.z;
    }
    ...
    {
        col_0[i32(3)] = col_0[i32(3)] * f16(f32(col_0.x + col_0.y + col_0.z) * 0.33333331346511841f);
    }
