...
@binding(32) @group(0) var _Tex_0 : texture_2d<f32>;

@binding(33) @group(0) var sampler_Tex_0 : sampler;

@binding(34) @group(0) var _OffsetTex_0 : texture_2d<f32>;

@binding(35) @group(0) var sampler_OffsetTex_0 : sampler;
