...
fn frag( _S2 : pixelInput_0, @builtin(position) pos_0 : vec4<f32>) -> pixelOutput_0
{
    ...
    var _S4 : vec3<f16> = _S3.xyz - vec3<f16>(f16(globalParams_0._Threshold_0));
    c_0.x = _S4.x;
    c_0.y = _S4.y;
    c_0.z = _S4.z;
    var _S5 : vec3<f16> = c_0.xyz / vec3<f16>(f16(globalParams_0._Transition_0));
    c_0.x = _S5.x;
    c_0.y = _S5.y;
    c_0.z = _S5.z;
    var _S6 : vec3<f16> = c_0.xyz + vec3<f16>(f16(globalParams_0._Transition_0 * 0.5f));
    c_0.x = _S6.x;
    c_0.y = _S6.y;
    c_0.z = _S6.z;
    var _S7 : vec3<f16> = saturate(c_0.xyz);
    c_0.x = _S7.x;
    c_0.y = _S7.y;
    c_0.z = _S7.z;
