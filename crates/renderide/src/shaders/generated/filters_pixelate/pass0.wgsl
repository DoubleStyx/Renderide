...
@binding(27) @group(0) var _ResolutionTex_0 : texture_2d<f32>;

@binding(28) @group(0) var sampler_ResolutionTex_0 : sampler;

@binding(29) @group(0) var _BackgroundTexture_0 : texture_2d<f32>;

@binding(30) @group(0) var sampler_BackgroundTexture_0 : sampler;
...
struct GlobalParams_std140_0
{
    ...
    @align(16) _ResolutionTex_ST_0 : vec4<f32>,
...
fn frag( _S2 : pixelInput_0, @builtin(position) pos_0 : vec4<f32>) -> pixelOutput_0
{
    ...
    var grabUv_0 : vec2<f32> = _S2.grabPos_0.xy / vec2<f32>(_S2.grabPos_0.w);
    var size_0 : vec2<f32>;
    if(USC_RESOLUTION_TEX_0)
    {
        size_0 = globalParams_0._Resolution_0 * (textureSample((_ResolutionTex_0), (unity_usc_resonite_macro_sampler_0), (_S2.uv_0.xy * globalParams_0._ResolutionTex_ST_0.xy + globalParams_0._ResolutionTex_ST_0.zw))).xy;
    }
    else
    {
        size_0 = globalParams_0._Resolution_0;
    }
    var _S3 : pixelOutput_0 = pixelOutput_0( vec4<f16>((textureSample((_BackgroundTexture_0), (unity_usc_resonite_macro_sampler_0), (round(grabUv_0 * size_0) / size_0)))) );
    return _S3;
}
