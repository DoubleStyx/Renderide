...
@group(2) @binding(5) var metallicGlossMap: texture_2d<f32>;
@group(2) @binding(6) var metallicGlossMap_sampler: sampler;
@group(2) @binding(7) var matcap: texture_2d<f32>;
@group(2) @binding(8) var matcap_sampler: sampler;
@group(2) @binding(9) var emissionMap: texture_2d<f32>;
@group(2) @binding(10) var emissionMap_sampler: sampler;
@group(2) @binding(11) var rampSelectionMask: texture_2d<f32>;
@group(2) @binding(12) var rampSelectionMask_sampler: sampler;
@group(2) @binding(13) var ramp: texture_2d<f32>;
@group(2) @binding(14) var ramp_sampler: sampler;
@group(2) @binding(15) var occlusionMap: texture_2d<f32>;
@group(2) @binding(16) var occlusionMap_sampler: sampler;
@group(2) @binding(17) var outlineMask: texture_2d<f32>;
@group(2) @binding(18) var outlineMask_sampler: sampler;
@group(2) @binding(19) var thicknessMap: texture_2d<f32>;
@group(2) @binding(20) var thicknessMap_sampler: sampler;
// --- End material block ---
