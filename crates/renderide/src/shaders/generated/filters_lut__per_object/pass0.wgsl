...
fn frag( _S2 : pixelInput_0, @builtin(position) pos_0 : vec4<f32>) -> pixelOutput_0
{
    ...
    var _S4 : vec3<f32> = vec3<f32>(_S3.xyz);
    var _S5 : vec3<f16> = vec3<f16>(mix((textureSample((_LUT_0), (unity_usc_resonite_macro_sampler_0), (_S4))).xyz, (textureSample((U_SecondaryLUT_0), (unity_usc_resonite_macro_sampler_0), (_S4))).xyz, vec3<f32>(globalParams_0._Lerp_0)));
    c_0.x = _S5.x;
    c_0.y = _S5.y;
    c_0.z = _S5.z;
