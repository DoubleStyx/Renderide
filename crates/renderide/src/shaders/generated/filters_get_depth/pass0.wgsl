...
struct GlobalParams_std140_0
{
    ...
    @align(8) _ClipMin_0 : f32,
    @align(4) _ClipMax_0 : f32,
...
struct v2f_0
{
    ...
    @location(2) position_0 : vec2<f32>,
};
...
struct pixelInput_0
{
    @location(0) uv_0 : vec2<f32>,
    @location(1) projPos_0 : vec4<f32>,
    @location(2) position_1 : vec2<f32>,
};

@fragment
fn frag( _S2 : pixelInput_0, @builtin(position) pos_0 : vec4<f32>) -> pixelOutput_0
{
    if(USC_RECTCLIP_0)
    {
    ...
    var depth_0 : f32 = LinearEyeDepth_0((textureSample((_CameraDepthTexture_0), (unity_usc_resonite_macro_sampler_0), (_S2.projPos_0.xy / vec2<f32>(_S2.projPos_0.w)))).x);
    var depth_1 : f32;
    if(USC_CLIP_0)
    {
        depth_1 = (depth_0 - globalParams_0._ClipMin_0) / (globalParams_0._ClipMax_0 - globalParams_0._ClipMin_0);
    }
    else
    {
        depth_1 = depth_0;
    }
    var _S3 : pixelOutput_0 = pixelOutput_0( vec4<f16>(vec3<f16>(vec3<f32>(saturate(depth_1 * globalParams_0._Multiply_0 + globalParams_0._Offset_0))), 1.0h) );
    return _S3;
}
