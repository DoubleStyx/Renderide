...
@group(2) @binding(3) var cutoutMask: texture_2d<f32>;
@group(2) @binding(4) var cutoutMask_sampler: sampler;
@group(2) @binding(5) var bumpMap: texture_2d<f32>;
@group(2) @binding(6) var bumpMap_sampler: sampler;
@group(2) @binding(7) var detailNormalMap: texture_2d<f32>;
@group(2) @binding(8) var detailNormalMap_sampler: sampler;
@group(2) @binding(9) var detailMask: texture_2d<f32>;
@group(2) @binding(10) var detailMask_sampler: sampler;
@group(2) @binding(11) var metallicGlossMap: texture_2d<f32>;
@group(2) @binding(12) var metallicGlossMap_sampler: sampler;
@group(2) @binding(13) var bakedCubemap: texture_cube<f32>;
@group(2) @binding(14) var bakedCubemap_sampler: sampler;
@group(2) @binding(15) var matcap: texture_2d<f32>;
@group(2) @binding(16) var matcap_sampler: sampler;
@group(2) @binding(17) var reflectivityMask: texture_2d<f32>;
@group(2) @binding(18) var reflectivityMask_sampler: sampler;
@group(2) @binding(19) var emissionMap: texture_2d<f32>;
@group(2) @binding(20) var emissionMap_sampler: sampler;
@group(2) @binding(21) var specularMap: texture_2d<f32>;
@group(2) @binding(22) var specularMap_sampler: sampler;
@group(2) @binding(23) var rampSelectionMask: texture_2d<f32>;
@group(2) @binding(24) var rampSelectionMask_sampler: sampler;
@group(2) @binding(25) var ramp: texture_2d<f32>;
@group(2) @binding(26) var ramp_sampler: sampler;
@group(2) @binding(27) var occlusionMap: texture_2d<f32>;
@group(2) @binding(28) var occlusionMap_sampler: sampler;
@group(2) @binding(29) var outlineMask: texture_2d<f32>;
@group(2) @binding(30) var outlineMask_sampler: sampler;
@group(2) @binding(31) var thicknessMap: texture_2d<f32>;
@group(2) @binding(32) var thicknessMap_sampler: sampler;
// --- End material block ---
