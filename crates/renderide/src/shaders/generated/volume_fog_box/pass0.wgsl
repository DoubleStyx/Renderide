...
struct GlobalParams_std140_0
{
    ...
    @align(16) _AccumulationColor_0 : vec4<f32>,
    @align(16) _AccumulationColorBottom_0 : vec4<f32>,
    @align(16) _AccumulationColorTop_0 : vec4<f32>,
    @align(16) _FogStart_0 : f32,
    @align(4) _FogEnd_0 : f32,
    @align(8) _FogDensity_0 : f32,
};
...
fn frag( _S1 : pixelInput_0) -> pixelOutput_0
{
    ...
    else
    {
        ...
        var _S6 : vec3<f32> = vec3<f32>(_S1.origin_0.xyz);
        if((- UnityObjectToViewPos_0(clamp_inside_unit_cube_0(clampedStartPos_0, vec3<f32>((vec3<f16>(0) - vec3<f16>(normalize(_S6 - clampedStartPos_0)))))).z) > sceneZ_0)
        {
            discard;
        }
        var camPos_2 : vec3<f32> = UnityPerCamera_0._WorldSpaceCameraPos_0.xyz;
        var _S7 : vec3<f32> = camPos_2 + vec3<f32>(sceneZ_0) * vec3<f32>(vec3<f16>(normalize((((vec4<f32>(_S6, 1.0f)) * (mat4x4<f32>(UnityPerDraw_0.unity_ObjectToWorld_0.data_0[i32(0)][i32(0)], UnityPerDraw_0.unity_ObjectToWorld_0.data_0[i32(1)][i32(0)], UnityPerDraw_0.unity_ObjectToWorld_0.data_0[i32(2)][i32(0)], UnityPerDraw_0.unity_ObjectToWorld_0.data_0[i32(3)][i32(0)], UnityPerDraw_0.unity_ObjectToWorld_0.data_0[i32(0)][i32(1)], UnityPerDraw_0.unity_ObjectToWorld_0.data_0[i32(1)][i32(1)], UnityPerDraw_0.unity_ObjectToWorld_0.data_0[i32(2)][i32(1)], UnityPerDraw_0.unity_ObjectToWorld_0.data_0[i32(3)][i32(1)], UnityPerDraw_0.unity_ObjectToWorld_0.data_0[i32(0)][i32(2)], UnityPerDraw_0.unity_ObjectToWorld_0.data_0[i32(1)][i32(2)], UnityPerDraw_0.unity_ObjectToWorld_0.data_0[i32(2)][i32(2)], UnityPerDraw_0.unity_ObjectToWorld_0.data_0[i32(3)][i32(2)], UnityPerDraw_0.unity_ObjectToWorld_0.data_0[i32(0)][i32(3)], UnityPerDraw_0.unity_ObjectToWorld_0.data_0[i32(1)][i32(3)], UnityPerDraw_0.unity_ObjectToWorld_0.data_0[i32(2)][i32(3)], UnityPerDraw_0.unity_ObjectToWorld_0.data_0[i32(3)][i32(3)])))).xyz - camPos_2)));
        camPos_0 = camPos_2;
        end_0 = _S7;
        start_0 = camPos_2;
    }
    if((distance_sqr_0(camPos_0, end_0)) < (distance_sqr_0(camPos_0, start_0)))
    {
        discard;
    }
    var dist_2 : f32 = distance(start_0, end_0);
    var dist_3 : f32;
    if(USC_FOG_LINEAR_0)
    {
        dist_3 = max(0.0f, min(globalParams_0._FogEnd_0, dist_2) - globalParams_0._FogStart_0);
    }
    else
    {
        dist_3 = dist_2;
    ...
    if(USC_FOG_EXP_0)
    {
        dist_3 = 1.0f - 1.0f / exp(dist_3 * globalParams_0._FogDensity_0);
    }
    if(USC_FOG_EXP2_0)
    {
        var d_0 : f32 = dist_3 * globalParams_0._FogDensity_0;
        dist_3 = 1.0f - 1.0f / exp(d_0 * d_0);
    }
    var accColor_0 : vec4<f32>;
    var _S8 : pixelOutput_0 = pixelOutput_0( vec4<f16>(globalParams_0._BaseColor_0 + vec4<f32>(pow(dist_3 * globalParams_0._AccumulationRate_0, globalParams_0._GammaCurve_0)) * accColor_0) );
    return _S8;
}
