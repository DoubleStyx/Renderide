...
fn frag( _S1 : pixelInput_0, @builtin(position) pos_1 : vec4<f32>) -> pixelOutput_0
{
    ...
    _S2.normalDir_1 = _S3;
    var _S4 : pixelOutput_0 = pixelOutput_0( vec4<f32>(vec4<f16>(vec3<f16>(vec3<f32>(max(0.0f, max(0.0f, dot(_S3, normalize(mix(UnityLighting_0._WorldSpaceLightPos0_0.xyz, UnityLighting_0._WorldSpaceLightPos0_0.xyz - _S2.posWorld_1.xyz, vec3<f32>(UnityLighting_0._WorldSpaceLightPos0_0.w))))))) * globalParams_0._LightColor0_0.xyz * globalParams_0._node_2829_0.xyz), 0.0h)) );
    return _S4;
}
