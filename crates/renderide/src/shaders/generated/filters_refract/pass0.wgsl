...
@binding(32) @group(0) var _BackgroundTexture_0 : texture_2d<f32>;

@binding(33) @group(0) var sampler_BackgroundTexture_0 : sampler;
...
struct v2f_0
{
    ...
    @location(7) tangent_0 : vec3<f32>,
    @location(4) bitangent_0 : vec3<f32>,
    @location(5) position_0 : vec2<f32>,
};

struct vertexInput_0
{
    @location(0) vertex_0 : vec4<f32>,
    @location(4) tangent_1 : vec4<f32>,
...
fn vert( _S5 : vertexInput_0) -> v2f_0
{
    ...
    var _S7 : vec3<f32> = UnityObjectToWorldNormal_0(_S5.normal_1);
    o_1.normal_0 = _S7;
    var _S8 : vec3<f32> = normalize((((vec4<f32>(_S5.tangent_1.xyz, 0.0f)) * (mat4x4<f32>(UnityPerDraw_0.unity_ObjectToWorld_0.data_0[i32(0)][i32(0)], UnityPerDraw_0.unity_ObjectToWorld_0.data_0[i32(1)][i32(0)], UnityPerDraw_0.unity_ObjectToWorld_0.data_0[i32(2)][i32(0)], UnityPerDraw_0.unity_ObjectToWorld_0.data_0[i32(3)][i32(0)], UnityPerDraw_0.unity_ObjectToWorld_0.data_0[i32(0)][i32(1)], UnityPerDraw_0.unity_ObjectToWorld_0.data_0[i32(1)][i32(1)], UnityPerDraw_0.unity_ObjectToWorld_0.data_0[i32(2)][i32(1)], UnityPerDraw_0.unity_ObjectToWorld_0.data_0[i32(3)][i32(1)], UnityPerDraw_0.unity_ObjectToWorld_0.data_0[i32(0)][i32(2)], UnityPerDraw_0.unity_ObjectToWorld_0.data_0[i32(1)][i32(2)], UnityPerDraw_0.unity_ObjectToWorld_0.data_0[i32(2)][i32(2)], UnityPerDraw_0.unity_ObjectToWorld_0.data_0[i32(3)][i32(2)], UnityPerDraw_0.unity_ObjectToWorld_0.data_0[i32(0)][i32(3)], UnityPerDraw_0.unity_ObjectToWorld_0.data_0[i32(1)][i32(3)], UnityPerDraw_0.unity_ObjectToWorld_0.data_0[i32(2)][i32(3)], UnityPerDraw_0.unity_ObjectToWorld_0.data_0[i32(3)][i32(3)])))).xyz);
    o_1.tangent_0 = _S8;
    o_1.bitangent_0 = normalize(cross(_S7, _S8) * vec3<f32>(_S5.tangent_1.w));
    o_1.grabPos_0 = ComputeGrabScreenPos_0(_S6);
    o_1.position_0 = _S5.vertex_0.xy;
...
{
    var _S2 : mat4x4<f32> = mat4x4<f32>(UnityPerFrame_0.unity_MatrixV_0.data_0[i32(0)][i32(0)], UnityPerFrame_0.unity_MatrixV_0.data_0[i32(1)][i32(0)], UnityPerFrame_0.unity_MatrixV_0.data_0[i32(2)][i32(0)], UnityPerFrame_0.unity_MatrixV_0.data_0[i32(3)][i32(0)], UnityPerFrame_0.unity_MatrixV_0.data_0[i32(0)][i32(1)], UnityPerFrame_0.unity_MatrixV_0.data_0[i32(1)][i32(1)], UnityPerFrame_0.unity_MatrixV_0.data_0[i32(2)][i32(1)], UnityPerFrame_0.unity_MatrixV_0.data_0[i32(3)][i32(1)], UnityPerFrame_0.unity_MatrixV_0.data_0[i32(0)][i32(2)], UnityPerFrame_0.unity_MatrixV_0.data_0[i32(1)][i32(2)], UnityPerFrame_0.unity_MatrixV_0.data_0[i32(2)][i32(2)], UnityPerFrame_0.unity_MatrixV_0.data_0[i32(3)][i32(2)], UnityPerFrame_0.unity_MatrixV_0.data_0[i32(0)][i32(3)], UnityPerFrame_0.unity_MatrixV_0.data_0[i32(1)][i32(3)], UnityPerFrame_0.unity_MatrixV_0.data_0[i32(2)][i32(3)], UnityPerFrame_0.unity_MatrixV_0.data_0[i32(3)][i32(3)]);
    var _S3 : vec2<f32> = vec2<f32>(1.0f);
    var vignettePos_0 : vec2<f32> = saturate((_S3 - abs(screenUv_1 * vec2<f32>(2.0f) - _S3)) * vec2<f32>(32.0f));
    var grabUv_0 : vec2<f32> = screenUv_1 - (((normalize(normal_0)) * (mat3x3<f32>(_S2[i32(0)].xyz, _S2[i32(1)].xyz, _S2[i32(2)].xyz)))).xy / vec2<f32>(grabPos_0.w) * vec2<f32>((globalParams_0._RefractionStrength_0 * mix(0.0f, saturate(evrDepthFade_0(screenUv_1, depth_0)), vignettePos_0.x * vignettePos_0.y)));
...
struct pixelInput_0
{
    ...
    @location(3) camDist_0 : f32,
    @location(6) normal_1 : vec3<f32>,
    @location(7) tangent_1 : vec3<f32>,
    @location(4) bitangent_1 : vec3<f32>,
    @location(5) position_1 : vec2<f32>,
};

@fragment
fn frag( _S4 : pixelInput_0, @builtin(position) pos_0 : vec4<f32>) -> pixelOutput_0
{
    if(USC_RECTCLIP_0)
    {
        if((UnityGet2DClipping_0(_S4.position_1, globalParams_0._Rect_0) - 0.10000000149011612f) < 0.0f)
        {
            discard;
        }
    }
    var _S5 : pixelOutput_0 = pixelOutput_0( vec4<f16>((textureSample((_BackgroundTexture_0), (unity_usc_resonite_macro_sampler_0), (vec2<f32>(evrCalculateRefractionCoords_0(_S4.grabPos_1.xy / vec2<f32>(_S4.grabPos_1.w), _S4.uv_1, _S4.depth_1, _S4.tangent_1, _S4.bitangent_1, _S4.normal_1, _S4.grabPos_1)))))) );
    return _S5;
}
