...
@binding(32) @group(0) var _LerpTex_0 : texture_2d<f32>;

@binding(33) @group(0) var sampler_LerpTex_0 : sampler;

@binding(34) @group(0) var _FarTex0_0 : texture_2d<f32>;

@binding(35) @group(0) var sampler_FarTex0_0 : sampler;

@binding(36) @group(0) var _FarTex1_0 : texture_2d<f32>;

@binding(37) @group(0) var sampler_FarTex1_0 : sampler;

@binding(38) @group(0) var _NearTex0_0 : texture_2d<f32>;

@binding(39) @group(0) var sampler_NearTex0_0 : sampler;

@binding(40) @group(0) var _NearTex1_0 : texture_2d<f32>;

@binding(41) @group(0) var sampler_NearTex1_0 : sampler;

@binding(42) @group(0) var _NormalMap0_0 : texture_2d<f32>;

@binding(43) @group(0) var sampler_NormalMap0_0 : sampler;

@binding(44) @group(0) var _NormalMap1_0 : texture_2d<f32>;

@binding(45) @group(0) var sampler_NormalMap1_0 : sampler;
...
struct GlobalParams_std140_0
{
    ...
    @align(4) _LerpPolarPow_0 : f32,
    @align(16) _LerpTex_ST_0 : vec4<f32>,
    @align(16) _FarTex0_ST_0 : vec4<f32>,
    @align(16) _FarTex1_ST_0 : vec4<f32>,
    @align(16) _NearTex0_ST_0 : vec4<f32>,
    @align(16) _NearTex1_ST_0 : vec4<f32>,
    @align(16) _NormalMap0_ST_0 : vec4<f32>,
    @align(16) _NormalMap1_ST_0 : vec4<f32>,
};
...
fn UnpackNormalmapRGorAG_0( packednormal_0 : vec4<f16>) -> vec3<f16>
{
    var _S1 : vec4<f16> = packednormal_0;
    _S1[i32(0)] = _S1[i32(0)] * packednormal_0.w;
    var _S2 : vec2<f16> = _S1.xy * vec2<f16>(2.0h) - vec2<f16>(1.0h);
    var normal_0 : vec3<f16>;
    normal_0.x = _S2.x;
    normal_0.y = _S2.y;
    normal_0[i32(2)] = sqrt(1.0h - saturate(dot(normal_0.xy, normal_0.xy)));
    return normal_0;
}

fn UnpackNormal_0( packednormal_1 : vec4<f16>) -> vec3<f16>
{
    return UnpackNormalmapRGorAG_0(packednormal_1);
}
...
fn frag( _S3 : pixelInput_0, @builtin(position) vertex_1 : vec4<f32>) -> pixelOutput_0
{
    ...
    _S4.normal_2 = normalize(_S4.normal_2);
    var l_0 : f16 = f16(EVR_INST_BUFFER_0._Lerp_0);
    if(USC_NORMALMAP_0)
    {
        _S4.normal_2 = normalize((((mat3x3<f32>(_S4.tangent_1, _S4.bitangent_1, _S4.normal_2)) * (vec3<f32>(UnpackNormal_0(vec4<f16>(mix((textureSample((_NormalMap0_0), (unity_usc_resonite_macro_sampler_0), (vec2<f32>(_S4.texcoord_1.xy) * globalParams_0._NormalMap0_ST_0.xy + globalParams_0._NormalMap0_ST_0.zw))), (textureSample((_NormalMap1_0), (unity_usc_resonite_macro_sampler_0), (vec2<f32>(_S4.texcoord_1.xy) * globalParams_0._NormalMap1_ST_0.xy + globalParams_0._NormalMap1_ST_0.zw))), vec4<f32>(vec4<f16>(l_0))))))))));
    }
    var fresnel_0 : f32 = pow(pow(1.0f - abs(dot(_S4.normal_2, normalize(UnityPerCamera_0._WorldSpaceCameraPos_0.xyz - _S4.position_1.xyz))), mix(globalParams_0._Exp0_0, globalParams_0._Exp1_0, f32(l_0))), globalParams_0._GammaCurve_0);
    var _S5 : vec4<f16> = vec4<f16>(l_0);
    var farColor_0 : vec4<f16> = mix(globalParams_0._FarColor0_0, globalParams_0._FarColor1_0, _S5);
    var nearColor_0 : vec4<f16> = mix(globalParams_0._NearColor0_0, globalParams_0._NearColor1_0, _S5);
    var nearColor_1 : vec4<f16>;
    var farColor_1 : vec4<f16>;
    if(USC_TEXTURE_0)
    {
        var _S6 : vec4<f32> = vec4<f32>(_S5);
        var farColor_2 : vec4<f16> = farColor_0 * vec4<f16>(mix((textureSample((_FarTex0_0), (unity_usc_resonite_macro_sampler_0), (vec2<f32>(_S4.texcoord_1.xy) * globalParams_0._FarTex0_ST_0.xy + globalParams_0._FarTex0_ST_0.zw))), (textureSample((_FarTex1_0), (unity_usc_resonite_macro_sampler_0), (vec2<f32>(_S4.texcoord_1.xy) * globalParams_0._FarTex1_ST_0.xy + globalParams_0._FarTex1_ST_0.zw))), _S6));
        nearColor_1 = nearColor_0 * vec4<f16>(mix((textureSample((_NearTex0_0), (unity_usc_resonite_macro_sampler_0), (vec2<f32>(_S4.texcoord_1.xy) * globalParams_0._NearTex0_ST_0.xy + globalParams_0._NearTex0_ST_0.zw))), (textureSample((_NearTex1_0), (unity_usc_resonite_macro_sampler_0), (vec2<f32>(_S4.texcoord_1.xy) * globalParams_0._NearTex1_ST_0.xy + globalParams_0._NearTex1_ST_0.zw))), _S6));
        farColor_1 = farColor_2;
    }
    else
    {
        nearColor_1 = nearColor_0;
        farColor_1 = farColor_0;
    }
    var _S7 : pixelOutput_0 = pixelOutput_0( vec4<f16>(mix(vec4<f32>(nearColor_1), vec4<f32>(farColor_1), vec4<f32>(fresnel_0))) );
    return _S7;
}
