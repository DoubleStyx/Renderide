...
@fragment
fn fragBase( _S1 : pixelInput_0, @builtin(position) pos_0 : vec4<f32>) -> pixelOutput_0
{
    ...
    var _S3 : vec3<f16> = _S2.xyz * (_S1.color_0.xyz * vec3<f16>(2.0h));
    o_0.x = _S3.x;
    o_0.y = _S3.y;
    o_0.z = _S3.z;
    var _S4 : vec3<f16> = mix((UnityPerFrame_0.glstate_lightmodel_ambient_0 * vec4<f16>(2.0h)).xyz * globalParams_0._Color_0.xyz, o_0.xyz, vec3<f16>(f16(max(1.0f, f32(1.0h - globalParams_0.U_ShadowStrength_0)))));
    o_0.x = _S4.x;
    o_0.y = _S4.y;
    o_0.z = _S4.z;
    o_0[i32(3)] = 1.0h;
    var _S5 : pixelOutput_0 = pixelOutput_0( o_0 );
    return _S5;
}
