...
struct pixelInput_0
{
    @location(0) data_0 : vec3<f32>,
};

@fragment
fn frag( _S1 : pixelInput_0, @builtin(position) vertex_0 : vec4<f32>) -> pixelOutput_0
{
    var _S2 : pixelOutput_0 = pixelOutput_0( vec4<f32>(saturate(_S1.data_0 * globalParams_0.U_Scale_0 + globalParams_0._Offset_0), 1.0f) );
    return _S2;
}
