...
fn frag( _S2 : pixelInput_0, @builtin(position) pos_0 : vec4<f32>) -> pixelOutput_0
{
    ...
    var _S4 : vec3<f16> = vec3<f16>((((vec3<f32>(_S3.xyz)) * (mat3x3<f32>(globalParams_0._LevelsR_0.xyz, globalParams_0._LevelsG_0.xyz, globalParams_0._LevelsB_0.xyz)))) + vec3<f32>(globalParams_0._LevelsR_0.w, globalParams_0._LevelsG_0.w, globalParams_0._LevelsB_0.w));
    c_0.x = _S4.x;
    c_0.y = _S4.y;
    c_0.z = _S4.z;
    var _S5 : vec3<f16> = vec3<f16>(max(globalParams_0._ClampMin_0.xyz, vec3<f32>(c_0.xyz)));
    c_0.x = _S5.x;
    c_0.y = _S5.y;
    c_0.z = _S5.z;
    var _S6 : vec3<f16> = vec3<f16>(min(globalParams_0._ClampMax_0.xyz, vec3<f32>(c_0.xyz)));
    c_0.x = _S6.x;
    c_0.y = _S6.y;
    c_0.z = _S6.z;
