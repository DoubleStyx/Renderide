//! `HistoryRegistry`: shared owner of every persistent history slot.
...
use super::buffer::BufferHistorySlot;
#[cfg(test)]
use super::buffer::BufferHistorySpec;
#[cfg(test)]
use super::buffer::buffer_specs_equivalent;
use super::texture::texture_specs_equivalent;
use super::texture::{TextureHistorySlot, TextureHistorySpec};
