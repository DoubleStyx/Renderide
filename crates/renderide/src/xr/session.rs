...
//! scene transforms share one world basis before [`crate::camera::apply_view_handedness_fix`]
...
pub(crate) mod end_frame_watchdog;
mod state;
mod view_math;
...
pub use view_math::{
    center_view_projection_from_stereo_views_aligned, eye_view_from_xr_view_aligned,
