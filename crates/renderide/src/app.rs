...
fn shader_source_label_for_request(
    request: &str,
            ...
            match draw.pipeline_variant {
                ...
                | PipelineVariant::NativeUiUnlitStencil { .. } => {
                    ...
                    let unsupported_state_checks = [
                        ...
                        ("_ColorMask", float_value(store, lookup, ids.color_mask), 15.0f32),
                        (
                            "_StencilComp",
                ...
                | PipelineVariant::NativeUiTextUnlitStencil { .. } => {
                    ...
                    let (_uniform, atlas_packed) = ui_text_unlit_material_uniform(store, lookup, ids);
