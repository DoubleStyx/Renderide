...
/// ancestor results are memoized. The old 64-entry grain generated dozens of short Rayon jobs for
/// ordinary character spaces, consuming substantially more aggregate worker time than wall time.
