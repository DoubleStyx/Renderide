...
pub(super) struct PendingBakeResources {
    ...
    /// Cube sampling view of the source pyramid retained for the convolve passes. -xlinka
...
/// Creates a cube sampling view of every mip in the source pyramid. -xlinka
pub(super) fn create_full_cube_sample_view(
    ...
    crate::profiling::note_resource_churn!(TextureView, "skybox::ibl_full_cube_sample_view");
    view
}
