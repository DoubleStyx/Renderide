        ...
        kv_table(ui, "graph_kv", |ui| {
            ...
            kv(
                ...
                &format!(
                    ...
                    r.upload_arena.arena.pressure.free_slots,
                    r.upload_arena.arena.pressure.in_flight_slots,
                    r.upload_arena.arena.pressure.remapping_slots
                ),
            );
            kv(
                ui,
                "Upload arena capacity",
                &hud_fmt::bytes_compact(r.upload_arena.arena.pressure.capacity_bytes),
            );
            kv(
                ui,
                "Upload staging",
                &format!(
                    ...
                    hud_fmt::bytes_compact(r.upload_arena.arena.acquire.persistent_staging_bytes),
                    hud_fmt::bytes_compact(r.upload_arena.arena.acquire.temporary_staging_bytes),
                    r.upload_arena.arena.acquire.persistent_slot_reuses,
                    r.upload_arena.arena.acquire.persistent_slot_grows
                ),
            );
            let upload_fallbacks = r
                ...
                .traffic
                .fallback_writes
                .saturating_add(r.upload_arena.arena.acquire.temporary_staging_fallbacks)
                .saturating_add(r.upload_arena.arena.acquire.oversized_queue_fallback_writes);
            kv_err_or_dim(
                ui,
                "Upload fallbacks",
                format!(
                    "{} write / {} temp / {} oversized",
                    r.upload_arena.traffic.fallback_writes,
                    r.upload_arena.arena.acquire.temporary_staging_fallbacks,
                    r.upload_arena.arena.acquire.oversized_queue_fallback_writes
                ),
            ...
            kv(
                ...
                &format!(
                    "{} writes / {}",
                    r.upload_arena.traffic.writes,
                    hud_fmt::bytes_compact(r.upload_arena.traffic.bytes as u64)
                ),
            );
