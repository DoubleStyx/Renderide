...
pub(crate) use frame_bindings::{
    ...
    GpuShadowLight, GpuShadowView, MAX_LIGHTS, MAX_SHADOW_VIEWS, REFLECTION_PROBE_ATLAS_FORMAT,
    REFLECTION_PROBE_METADATA_BOX_PROJECTION, REFLECTION_PROBE_METADATA_SH2_SOURCE_LOCAL,
    SHADOW_ARRAY_LAYERS, SHADOW_DEPTH_FORMAT, empty_material_bind_group_layout,
