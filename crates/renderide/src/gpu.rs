...
pub(crate) use frame_bindings::{
    ...
    LIGHT_COOKIE_KIND_DIRECTIONAL_2D, LIGHT_COOKIE_KIND_NONE, LIGHT_COOKIE_KIND_POINT_CUBE,
    LIGHT_COOKIE_KIND_SPOT_2D, LIGHT_COOKIE_WRAP_MODE_CLAMP, LIGHT_COOKIE_WRAP_MODE_MASK,
