...
public sealed class GlobMatcherTests
{
    ...
    {
        string[] patterns = { "generators/UnityShaderConverter/SampleShaders/**/*.shader" };
        Assert.True(GlobMatcher.MatchesAny("generators/UnityShaderConverter/SampleShaders/MinimalUnlit.shader", patterns));
