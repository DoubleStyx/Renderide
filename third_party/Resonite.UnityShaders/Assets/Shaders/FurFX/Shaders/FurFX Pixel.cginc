...
fixed4 frag (v2f i) : COLOR
{
	...
	o.a = clamp(noiseAvg * max(o.a,_SkinAlpha) - (FUR_MULTIPLIER*FUR_MULTIPLIER)*_EdgeFade,0,1);
...
fixed4 fragShadow (v2f i) : COLOR
{
	...
	//o.a = min(noise * (1-FUR_MULTIPLIER*FUR_MULTIPLIER),1) * max(o.a,_SkinAlpha);
	fixed noiseAvgShadow = dot(noise, fixed3(0.333333, 0.333333, 0.333333));
	o.a = clamp(noiseAvgShadow - (FUR_MULTIPLIER*FUR_MULTIPLIER)*_EdgeFade,0,1);
		
    //o.a =  noise;			
		
	o.rgb *= i.color.rgb * 2 * LIGHT_ATTENUATION(i);
